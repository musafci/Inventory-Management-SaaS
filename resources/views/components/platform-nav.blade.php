...
<nav class="sidebar-scroll flex flex-1 flex-col gap-0.5 overflow-y-auto pb-4">
    ...
    <a href="{{ route('platform.activity-logs.index') }}"
       class="nav-link {{ str_contains($current, 'platform.activity-logs') ? 'nav-link-active' : 'nav-link-inactive' }}">
    ...
    <a href="{{ route('platform.admins.index') }}"
       class="nav-link {{ str_contains($current, 'platform.admins') ? 'nav-link-active' : 'nav-link-inactive' }}">
