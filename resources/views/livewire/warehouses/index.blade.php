    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex-1 max-w-lg">
            <div class="relative">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" class="form-input pl-10" placeholder="Search warehouses..." wire:loading.class="search-loading" wire:target="search">
            </div>
        </div>
                    ...
                    <form wire:submit.prevent="{{ $editingId ? 'update' : 'store' }}">
                        ...
                        <div class="px-6 py-4 space-y-4">
                            <div>
                                ...
                                <input type="text" wire:model="form.name" class="form-input" placeholder="Warehouse name">
