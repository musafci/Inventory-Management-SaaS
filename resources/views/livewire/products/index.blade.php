    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex-1 max-w-lg">
            <div class="relative">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" class="search-input" placeholder="Search products..." wire:loading.class="search-loading" wire:target="search">
            </div>
        </div>
            ...
            <div class="flex min-h-full items-end justify-center px-4 pb-4 pt-4 sm:items-center sm:p-0">
                ...
                <div class="relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8">
                    <form wire:submit.prevent="importCsv">
                        <div class="border-b border-gray-100 px-6 py-4">
                            <h3 class="text-lg font-semibold text-gray-900">Import Products from CSV</h3>
                            <p class="mt-1 text-sm text-gray-500">Upload a CSV file with a header row. Category and unit are matched by name.</p>
                        </div>
