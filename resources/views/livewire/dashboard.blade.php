<div x-data="dashboardCounters()" x-init="init()">
    {{-- Welcome banner --}}
    <div class="page-banner">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between relative z-10">
            ...
            <div class="flex gap-3">
                <a href="/products/create" class="inline-flex items-center gap-2 rounded-xl bg-white/15 px-4 py-2.5 text-sm font-semibold text-white ring-1 ring-white/20 backdrop-blur-sm transition-all hover:bg-white/25 hover:-translate-y-px hover:shadow-lg">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
                    Add Product
                </a>
                <a href="/reports" class="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-primary-700 shadow-sm transition-all hover:bg-primary-50 hover:-translate-y-px hover:shadow-md">
    ...
    <div class="mb-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div class="stat-card stat-card-primary animate-fade-in-up" style="animation-delay: 0ms">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold tracking-tight text-slate-900" x-text="animatedProducts">0</p>
                </div>
            </div>
        </div>
        <div class="stat-card stat-card-emerald animate-fade-in-up" style="animation-delay: 60ms">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold tracking-tight text-slate-900" x-text="animatedStock">0</p>
                </div>
            </div>
        </div>
        <div class="stat-card stat-card-amber animate-fade-in-up" style="animation-delay: 120ms">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold tracking-tight text-slate-900" x-text="animatedPurchaseOrders">0</p>
                </div>
            </div>
        </div>
        <div class="stat-card stat-card-sky animate-fade-in-up" style="animation-delay: 180ms">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold tracking-tight text-slate-900" x-text="animatedSalesOrders">0</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="card animate-fade-in-up" style="animation-delay: 240ms">
            <div class="card-header flex items-center justify-between">
                ...
                <a href="/reports" class="text-xs font-semibold text-primary-600 hover:text-primary-500 transition-colors">View all</a>
            </div>
            <div class="p-6">
                ...
                @else
                    <div class="space-y-3">
                        @foreach($lowStockItems as $item)
                            <div class="flex items-center justify-between rounded-xl bg-amber-50/80 p-4 ring-1 ring-amber-100 transition-all hover:shadow-sm">
        ...
        <div class="card animate-fade-in-up" style="animation-delay: 300ms">
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4">
                    <a href="/products/create" class="action-tile group">
                        <div class="action-tile-icon bg-gradient-to-br from-primary-50 to-primary-100 ring-1 ring-primary-200/50">
                        ...
                        <span class="text-sm font-semibold text-slate-700 group-hover:text-primary-700 transition-colors">New Product</span>
                    </a>
                    <a href="/purchase-orders/create" class="action-tile group">
                        <div class="action-tile-icon bg-gradient-to-br from-amber-50 to-amber-100 ring-1 ring-amber-200/50">
                        ...
                        <span class="text-sm font-semibold text-slate-700 group-hover:text-amber-700 transition-colors">Purchase Order</span>
                    </a>
                    <a href="/sales-orders/create" class="action-tile group">
                        <div class="action-tile-icon bg-gradient-to-br from-sky-50 to-sky-100 ring-1 ring-sky-200/50">
                        ...
                        <span class="text-sm font-semibold text-slate-700 group-hover:text-sky-700 transition-colors">Sales Order</span>
                    </a>
                    <a href="/stock-movements/create" class="action-tile group">
                        <div class="action-tile-icon bg-gradient-to-br from-emerald-50 to-emerald-100 ring-1 ring-emerald-200/50">
                        ...
                        <span class="text-sm font-semibold text-slate-700 group-hover:text-emerald-700 transition-colors">Stock Adjustment</span>
                    </a>
                </div>
            </div>
        </div>
...
function dashboardCounters() {
    return {
        targetProducts: {{ $stats['total_products'] ?? 0 }},
        targetStock: {{ $stats['total_stock_items'] ?? 0 }},
        targetPurchaseOrders: {{ $stats['pending_purchase_orders'] ?? 0 }},
        targetSalesOrders: {{ $stats['pending_sales_orders'] ?? 0 }},
        animatedProducts: 0,
        animatedStock: 0,
        animatedPurchaseOrders: 0,
        animatedSalesOrders: 0,
        init() {
            this.animateCounter('animatedProducts', this.targetProducts, 800);
            this.animateCounter('animatedStock', this.targetStock, 800);
            this.animateCounter('animatedPurchaseOrders', this.targetPurchaseOrders, 800);
            this.animateCounter('animatedSalesOrders', this.targetSalesOrders, 800);
        },
        animateCounter(prop, target, duration) {
            ...
            const step = (now) => {
                ...
                this[prop] = Math.round(eased * target).toLocaleString();
